...
def test_examples_have_required_fields():
    ...
    try:
        from miriam_agent.spec.examples import parse_spec_examples, SpecExample
        
        markdown = load_markdown()
        examples = parse_spec_examples(markdown)
        
        for example in examples:
            assert isinstance(example, SpecExample), f"Example should be SpecExample: {example}"
            ...
            assert example.failure_mode_prevented, "Example should have failure mode prevented"
    ...
    try:
        ...
        for example in examples:
            ...
            assert not violations, \
                f"Good example {example.id} should pass lint but has violations: {violations}"
